...
def run() -> None:
    rc.graph.DatasetLoader
    # rv = rc.loader.DatasetLoader.builder().cached(True).hospital().unweighted().load()
    test_conference_uw()
    test_conference_w()
...
def test_conference_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().conference().cached(False).unweighted().load(),
        )
    )
...
def test_conference_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().conference().cached(False).weighted().load(),
        )
    )
...
def test_primary_school_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().primary_school().cached(False).unweighted().load(),
        )
    )
...
def test_primary_school_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().primary_school().cached(False).weighted().load(),
        )
    )
...
def test_high_school_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().high_school().cached(False).unweighted().load(),
        )
    )
...
def test_high_school_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().high_school().cached(False).weighted().load(),
        )
    )
...
def test_facebook_hs_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().facebook_hs().cached(False).unweighted().load(),
        )
    )
...
def test_friendship_hs_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().friendship_hs().cached(False).unweighted().load(),
        )
    )
...
def test_friendship_hs_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().friendship_hs().cached(False).weighted().load(),
        )
    )
...
def test_gene_disease_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().gene_disease().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_pacs_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().pacs().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_pacs_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().pacs().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_workspace_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().workspace().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_workspace_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().workspace().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_dblp_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().DBLP().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_dblp_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().DBLP().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_history_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().history().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_history_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().history().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_geology_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().geology().cached(cache_dir()).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_geology_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().geology().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_justice_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().justice().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_justice_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().justice().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
#         lambda: DatasetLoader.builder().babbuini().cached(False).unweighted().limit_edge_size(10).load(),
#     ))
#
# def test_babbuini_w():
#     console.print(test_loader(
...
#         lambda: DatasetLoader.builder().babbuini().cached(False).weighted().limit_edge_size(10).load(),
#     ))
...
def test_wiki_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().wiki().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_wiki_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().wiki().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_ndc_substances_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().NDC_substances().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_ndc_substances_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().NDC_substances().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_ndc_classes_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().NDC_classes().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_ndc_classes_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().NDC_classes().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_eu_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().eu().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_eu_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().eu().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
...
def test_enron_uw():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().enron().cached(False).unweighted().limit_edge_size(10).load(),
        )
    )
...
def test_enron_w():
    console.print(
        test_loader(
            ...
            lambda: DatasetLoader.builder().enron().cached(False).weighted().limit_edge_size(10).load(),
        )
    )
